      ...
      if (realHour == storedHour_1 && realMinute == storedMinute_1 && m == alarmMonth_1 && d == alarmDay_1 && yr == alarmYear_1) { //alarm#1
          ...
          if (ir_1 == LOW){ 
            ...
            for( uint32_t tStart_1 = millis();  (millis()-tStart_1) < period_1;  ){
               ...
               lcd1.print("Day: " + currentDOW);
                 ...
                 uint32_t pulseperiod_1 = 1 * 60000L;       // 1 minute loop
        ...
        if (realHour == storedHour_4 && realMinute == storedMinute_4 && m == alarmMonth_4 && d == alarmDay_4 && yr == alarmYear_4) { //alarm#1
              ...
              if (ir_1 == LOW){
                ...
                uint32_t period_4 = 2 * 60000L;       // 5 minutes loop
...
String getInputFromKeyBoard(int n) {
  ...
  while (1) {
    ...
    if (key) {
      ...
      if ((key == '#' || key == 'A' || key == 'B' || key == 'C' || key == 'D') && i < n) { //u change
        lcd1.clear();
...
void IR_1(){
  ...
  ir_1 =digitalRead(IRPin_1);
          if (ir_1 == LOW){ //detect
           ...
           if(on_slot1 == true){
            uint32_t period_5 = 2 * 60000L;       // 5 minutes loop
            ...
            if(on_slot2 == true){
            uint32_t period_6 = 2 * 60000L;       // 5 minutes loop
            ...
            if(on_slot3 == true){
            uint32_t period_7 = 2 * 60000L;       // 5 minutes loop
            ...
            if(on_slot4 == true){
            uint32_t period_8 = 2 * 60000L;       // 5 minutes loop
